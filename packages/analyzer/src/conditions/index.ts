...
export { extractExecText, extractStagedContent, isStagedTarget, isExecTool, isWriteTool, patchTargets, type StagedContent } from "./scope.js";
export { extractWriteTargets } from "./write-targets.js";
